...
export class DokiCoin extends ethereum.SmartContract {
  static bind(address: Address): DokiCoin {
    return new DokiCoin("DokiCoin", address);
  }
  ...
  getLockStatus(): boolean {
    let result = super.call("getLockStatus", "getLockStatus():(bool)", []);

    return result[0].toBoolean();
  }

  try_getLockStatus(): ethereum.CallResult<boolean> {
    let result = super.tryCall("getLockStatus", "getLockStatus():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  isInWhitelist(account: Address): boolean {
  ...
  try_isInWhitelist(account: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "isInWhitelist",
  ...
  taxDestination(): Address {
    let result = super.call("taxDestination", "taxDestination():(address)", []);

    return result[0].toAddress();
  }

  try_taxDestination(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "taxDestination",
      "taxDestination():(address)",
      []
  ...
  taxRate(): BigInt {
    let result = super.call("taxRate", "taxRate():(uint256)", []);

    return result[0].toBigInt();
  }

  try_taxRate(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("taxRate", "taxRate():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  taxer(): Address {
    let result = super.call("taxer", "taxer():(address)", []);

    return result[0].toAddress();
  }

  try_taxer(): ethereum.CallResult<Address> {
    let result = super.tryCall("taxer", "taxer():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class SetTaxDestinationCall extends ethereum.Call {
  get inputs(): SetTaxDestinationCall__Inputs {
    return new SetTaxDestinationCall__Inputs(this);
  }

  get outputs(): SetTaxDestinationCall__Outputs {
    return new SetTaxDestinationCall__Outputs(this);
  }
}

export class SetTaxDestinationCall__Inputs {
  _call: SetTaxDestinationCall;

  constructor(call: SetTaxDestinationCall) {
    this._call = call;
  }
...
export class SetTaxDestinationCall__Outputs {
  _call: SetTaxDestinationCall;
...
export class SetTaxerCall extends ethereum.Call {
  get inputs(): SetTaxerCall__Inputs {
    return new SetTaxerCall__Inputs(this);
  }

  get outputs(): SetTaxerCall__Outputs {
    return new SetTaxerCall__Outputs(this);
  }
}

export class SetTaxerCall__Inputs {
  _call: SetTaxerCall;

  constructor(call: SetTaxerCall) {
    this._call = call;
  }
...
export class SetTaxerCall__Outputs {
  _call: SetTaxerCall;
